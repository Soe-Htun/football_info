  ...
  return (
    <div className='grid grid-cols-3'>
      <div className='w-full flex items-center'>
        ...
        <p className='text-sm'>{data?.homeTeam?.shortName == 'Atleti'? 'Atletico Madrid' : data?.homeTeam?.shortName }</p>
      </div> 
      ...
      <div className='w-full flex items-center justify-end'>
        <p className='text-sm text-right'>{data?.awayTeam?.shortName == 'Atleti'? 'Atletico Madrid' : data?.awayTeam?.shortName }</p>
